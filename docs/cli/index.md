...
- `config`: Path or URL to a valid configuration file. See details about the configuration schema in the [observability chapter](../observability/alerting.md#configuration).
